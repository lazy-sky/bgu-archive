...
export default function Home() {
  return (
    <main className="mx-auto flex max-w-3xl flex-1 flex-col justify-center px-4 py-10 sm:px-6 sm:py-16">
      <p className="text-sm font-medium uppercase tracking-widest text-amber-800/70">
        BoardGameUnion
      </p>
      ...
      <p className="mt-4 text-base leading-relaxed text-amber-900/80 sm:text-lg">
        동아리에서 모은 보드게임 정보를 한곳에서 찾고, 인원·장르에 맞는 게임을
        고르고, 누가 룰을 설명할 수 있는지까지 이어가는 아카이브의 시작점입니다.
      </p>
